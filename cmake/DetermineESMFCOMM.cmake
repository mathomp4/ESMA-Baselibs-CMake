...
if(NOT BUILD_MPI)
   ...
   elseif(MPI_Fortran_LIBRARY_VERSION_FIRSTWORD MATCHES "Open")
      ...
      list(GET MPI_Fortran_LIBRARY_VERSION_LIST 9 DETECTED_MPI_VERSION_STRING_WITH_COMMA)
      string(REPLACE "," "" DETECTED_MPI_VERSION_STRING ${DETECTED_MPI_VERSION_STRING_WITH_COMMA})
   endif()
endif()
